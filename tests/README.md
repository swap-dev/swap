...
```bash
swapd --regtest --offline --fixed-difficulty 1
```
...
Open the wallet file with `swap-wallet-rpc` with RPC port 18083. Finally, start tests by invoking ./blockchain.py or ./speed.py
